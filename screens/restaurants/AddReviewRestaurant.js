...
import { Button, AirbnbRating, Rating, Input  } from 'react-native-elements'
...
export default function AddReviewRestaurant({ navigation, route }) {
    ...
    const addReview = async () => {
        ...
        if (!responseAddReview.statusReponse) {
            setLoading(false)
        ...
        if (!responseGetRestaurant.statusReponse) {
            setLoading(false)
        ...
        if (!responseUpdateRestaurant.statusReponse) {
            setLoading(false)
